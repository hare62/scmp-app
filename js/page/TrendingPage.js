...
export default class TrendingPage extends Component {
    ...
    createDailyData() {
        ...
        return this.onSelectFilterConditionData( new FilterConditionData('今 天', 'since=daily'))
    }
    ...
    createWeeklyData() {
        ...
        return this.onSelectFilterConditionData(new FilterConditionData('本 周', 'since=weekly'))
    }
